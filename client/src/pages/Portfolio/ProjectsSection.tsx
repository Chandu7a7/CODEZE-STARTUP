...
import NamasteCafeImg from "../../assets/Namaste-Food-Express.png";

import UniBillImg from "../../assets/UniBill-Pro.png";

import PuruliaTravelsImg from "../../assets/Purulia-Travels.png";
...
const projects = [
  {
    ...
    image: NamasteCafeImg,

    link:
      "https://namatecafe.web.app/",
  },
...

  {
    ...
    image: PuruliaTravelsImg,

    link:
      "https://puruliatravelsfinal.netlify.app/",
  },

  {
    ...
    link:
      "https://hangry-frontend-seven.vercel.app/",
  },
];
...
const ProjectsSection = () => {
  return (
    <section className="relative overflow-hidden bg-[#f8fbff] py-16 sm:py-20 lg:py-24">
      ...
      {/* Blur Effects */}
      <div className="absolute top-0 right-0 w-[280px] sm:w-[380px] h-[280px] sm:h-[380px] bg-cyan-200/20 blur-3xl rounded-full animate-pulse" />

      <div className="absolute bottom-0 left-0 w-[240px] sm:w-[320px] h-[240px] sm:h-[320px] bg-blue-200/20 blur-3xl rounded-full animate-pulse" />

      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Heading */}
        <div className="max-w-3xl">
          {/* Badge */}
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-blue-100 bg-white/80 backdrop-blur-xl text-[10px] font-bold tracking-[2px] uppercase text-blue-600 shadow-sm mb-5 animate-fade-up">
          ...
          {/* Description */}
          <p className="mt-5 max-w-2xl text-[13px] sm:text-[14px] leading-7 text-slate-500 animate-fade-up delay-100">
          ...
          {projects.map(
            (project, index) => (
              <a
                ...
                className="group relative overflow-hidden rounded-[24px] sm:rounded-[28px] border border-white/70 bg-white/85 backdrop-blur-2xl p-3 shadow-[0_10px_35px_rgba(59,130,246,0.05)] hover:-translate-y-2 hover:shadow-[0_20px_60px_rgba(59,130,246,0.10)] transition-all duration-500"
              >
                {/* Image */}
                <div className="relative overflow-hidden rounded-[20px]">
                  ...
                  <img
                    src={project.image}
                    alt={project.title}
                    className="w-full h-[220px] sm:h-[260px] md:h-[280px] object-cover rounded-[20px] group-hover:scale-105 transition-all duration-700"
                  />
                </div>
                ...
                <div className="p-4 sm:p-5">
                  ...
                  {/* Title */}
                  <h3 className="mt-5 text-[24px] sm:text-[28px] font-bold tracking-[-1px] leading-[1.05] text-slate-900">
                    {project.title}
                  </h3>
